...
_cargo_make_completions2()
{
    ALL_WORDS=("${ALL_WORDS}$(makers --loglevel error --list-all-steps --output-format autocomplete | sed -e 's/init\|end\|empty//g')")
    COMPREPLY=($(compgen -W "$ALL_WORDS" -- "${COMP_WORDS[1]}"))
}

complete -F _cargo_make_completions2 makers
